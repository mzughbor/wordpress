  ...
  <section id="content">
    <div class="content-wrap">
      ...
      if( !is_single() && is_home() &&
          ...
          get_theme_mod('mz_show_header_popular_posts')){
          wpp_get_mostpopular([
          'wpp_start'     => ' <div class="section header-stick bottommargin-lg clearfix" style="padding: 20px 0;">
                                  <div>
                                  <div class="container clearfix">
                                  <span class="badge badge-danger bnews-title">'.get_theme_mod( 'mz_popular_posts_widget_title' ).'</span>
  ...
  <div id="posts">
    ...
    if (have_posts()){
      while (have_posts()) {
        ...
        // template part are a way to split up your template that can be reusable.
